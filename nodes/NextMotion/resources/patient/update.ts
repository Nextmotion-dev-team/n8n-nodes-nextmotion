...
const showOnlyForPatientUpdate = {
	operation: ['update'],
	resource: ['patient'],
};

export const patientUpdateDescription: INodeProperties[] = [
	{
		...
		options: [
			...
			},
			{
				...
				description: 'Doctor ID of the patient provider',
				routing: {
					send: {
						type: 'body',
						property: 'doctor',
